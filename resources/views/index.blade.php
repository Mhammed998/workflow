...
<body>
    ...
    @if ($ShowOnHeroArticles && count($ShowOnHeroArticles) > 0)
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-7 px-0">
                    <div class="owl-carousel main-carousel position-relative">
                        @foreach ($ShowOnHeroArticles->take(3) as $article)
                            <div class="position-relative overflow-hidden" style="height: 500px;">
                                <img class="img-fluid h-100" src="{{ $article?->image() }}" style="object-fit: cover;">
                                <div class="overlay">
                                    <div class="mb-2">
                                        <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2"
                                            href="">{{ $article?->category?->name }}</a>
                                        <a class="text-white" href="">{{ $article?->date }}</a>
                                    </div>
                                    <a class="h2 m-0 text-white text-uppercase font-weight-bold"
                                        href="{{ route('show-article', $article) }}">{{ $article?->title }}</a>
                                </div>
                            </div>
                        @endforeach
                    </div>
                ...
                <div class="col-lg-5 px-0">
                    <div class="row mx-0">
                        @foreach ($ShowOnHeroArticles->skip(3) as $article)
                            <div class="col-md-6 px-0">
                                <div class="position-relative overflow-hidden" style="height: 250px;">
                                    <img class="img-fluid w-100 h-100" src="{{ $article?->image() }}"
                                    ...
                                    <div class="overlay">
                                        <div class="mb-2">
                                            <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2"
                                                href="">{{ $article?->category?->name }}</a>
                                            <a class="text-white"
                                                href=""><small>{{ $article?->date }}</small></a>
                                        </div>
    ...
    <!-- Breaking News Start -->
    @if ($breakingArticles && count($breakingArticles) > 0)
    ...
    @if ($featuredArticles && count($featuredArticles) > 0)
                        ...
                        <div class="position-relative overflow-hidden" style="height: 300px;">
                            ...
                            <div class="overlay">
                                <div class="mb-2">
                                    <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2"
                                        href="">{{ $article?->category?->name }}</a>
                                    <a class="text-white" href=""><small>{{ $article?->date }}</small></a>
                                </div>
                                <a class="h6 m-0 text-white text-uppercase font-weight-semi-bold"
                                    href="">{{ $article?->title }}</a>
                            </div>
                            ...
                            @foreach ($latestArticles as $article)
                                <div class="col-lg-6">
                                    <div class="position-relative mb-3">
                                        <img class="img-fluid w-100" src="{{ $article?->image() }}"
                                            style="object-fit: cover;">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="bg-white text-center border border-top-0 p-3">
                            <a href=""><img class="img-fluid"
                                    src="{{ asset('assets') }}/img/news-800x500-2.jpg" alt=""></a>
                        </div>
                    </div>
                    <!-- Ads End -->

                    <!-- Popular News Start -->
                    @if ($trendingArticles && count($trendingArticles) > 0)
                        <div class="mb-3">
                            <div class="section-title mb-0">
                            ...
                            <div class="bg-white border border-top-0 p-3">
                                @foreach ($trendingArticles as $article)
                                    <div class="d-flex align-items-center bg-white mb-3" style="height: 110px;">
                                        <img class="img-fluid1" src="{{ $article?->image() }}" alt=""
                                            height="80px">
                                        <div
